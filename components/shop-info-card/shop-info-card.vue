<template>
  ...
  >
    <view class="shop-info-card__content">
      <uni-list>
        <uni-list-item title="营业时间" :note="businessHours" :clickable="true">
          <template #header>
        ...
        <uni-list-item title="联系电话" :note="phone" :clickable="true" @click="handlePhoneClick">
          <template #header>
            <view class="icon-container">
...
const cardClass = computed(() => {
  return {
    'shop-info-card--open': properties.businessStatusClass === 'status-open',
    'shop-info-card--closed': properties.businessStatusClass === 'status-closed'
  }
})
